...
(63, 'Beautiful guitar', 90000, 'A beautiful new guitar sold at the best price, although one string is broken, it still works.', 1, 'beautiful,guitar,new,String,Brown', 'dydierripe@gmail.com', 'no-owner'),
...
(67, 'very very big piano', 300000, 'I really love this piano, take care of it, if not I will kill u', 2, 'big,Percussion', 'dydierripe@gmail.com', 'no-owner'),
...
(69, 'chayanne', 1000000, 'lo vendo como esclavo, quien este interesado, comprelo, quien no vayase', 7, 'chayanne,padre,latinoamerica,unida,Other,White', 'dydierripe@gmail.com', 'no-owner'),
...
(87, 'una cuerda cualquiera', 5000, 'literalmente no se ni de que nota es esto, supongo que sera de las agudas, me la encontre en el pisoel otro dia', 6, 'aguda,metal,guitarra,Parts', 'yeikmauriciopulidoquitian@gmail.com', 'no-owner');
...
ALTER TABLE `products`
  ...
  ADD CONSTRAINT `products_ibfk_2` FOREIGN KEY (`seller`) REFERENCES `users` (`email`);
COMMIT;
