...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 05, 2023 at 09:01 AM
...
--
ALTER TABLE `reports`
  ADD CONSTRAINT `reports_ibfk_1` FOREIGN KEY (`seller`) REFERENCES `users` (`email`),
...
--
ALTER TABLE `solditems`
  ADD CONSTRAINT `solditems_ibfk_1` FOREIGN KEY (`seller`) REFERENCES `users` (`email`);
COMMIT;
