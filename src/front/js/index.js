...
setInterval(() => {
    ...
    setTimeout(() => {
        image[0].firstElementChild.src = oneOrTo? "media/images/canasta escrito.png" : "media/images/top-image.png";
        image[1].firstElementChild.src = oneOrTo? "media/images/top-image.png" : "media/images/canasta escrito.png";
