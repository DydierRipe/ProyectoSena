...
document.addEventListener("keyup", e => {
    if (searchB) {
        if (e.key == "Enter" && searchB.value.length != 0 && searchB === document.activeElement) {
            window.location.replace('/' + languaje + "/search" + "#" + searchB.value);
        }    
    }
});
...
cart.addEventListener("click", () => {
    window.location.replace('/' + languaje + "/reserved");
});
...
menu.addEventListener("click", () => {
    ...
    item1.addEventListener("click", () => window.location.replace('/' + languaje + '/creating'));
    item2.addEventListener("click", () => window.location.replace('/' + languaje + '/search'));
...
if (userString === null) {
    ...
    usIcon.addEventListener("click", () => {
        ...
        item1.addEventListener("click", () => window.location.replace('/' + languaje + '/login'));
        item2.addEventListener("click", () => window.location.replace('/' + languaje + '/signup'));
    ...
    usIcon.addEventListener("click", () => {
        ...
        item1.addEventListener("click", () => {
            ...
            window.location.replace('/' + languaje + "/login");
        });
